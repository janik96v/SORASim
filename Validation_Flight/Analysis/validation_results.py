...
val_data1 = pd.read_csv('DJIFlightRecord_2022-08-25_[10-38-43].csv', sep=',')
val_data2 = pd.read_csv('DJIFlightRecord_2022-08-25_[10-42-05].csv', sep=',')
val_data3 = pd.read_csv('DJIFlightRecord_2022-08-25_[10-45-30].csv', sep=',')
val_flights = [val_data1,val_data2,val_data3]

##Simulation Data
sim_data1 = pd.read_csv('validation_final1.csv', sep=';')
sim_data2 = pd.read_csv('validation_final2.csv', sep=';')
sim_data3 = pd.read_csv('validation_final3.csv', sep=';')
...
sim_data_comparison = pd.read_csv('validation_no_adjustments.csv', sep=';')
sim_data_comparison2 = pd.read_csv('validation_no_adjustments2.csv', sep=';')
sim_data_comparison3 = pd.read_csv('validation_no_adjustments3.csv', sep=';')
...
##Waypoints
waypoints = pd.read_excel('Flight_Plan_Validation_angepasst.xlsx')
