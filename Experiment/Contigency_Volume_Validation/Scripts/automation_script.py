...
import mission_script_CV_validation as mission
import asyncio
...
for i in range(0,len(world),1):
    ...
    for j in range(1,runs+1,1):
        ...
        #Connecting
        client.connect('YOUR_IP_ADDRESS', username='USERNAME') #Add your IP address and the username of the machine you want to SSH
        ...
        #Clears global variables of mission script for empty log file each run
